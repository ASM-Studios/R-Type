...
static void handleUpdatePlayer(network::Client client, RawRequest request) {
...
static void handleUpdateTeamPlayer(network::Client client, RawRequest request) {
...
static void handleCreateEntity(network::Client client, RawRequest request) {
...
static void handlePing(network::Client client, RawRequest request) {
